%% Project Description
% This project focuses on Kangerlussuaq glacier, Greenland, and how it
...
%Recommened Papers:
% Brough et al (2019) - https://doi.org/10.3389/feart.2019.00123
% Barnett et al (2022) - https://doi.org/10.1017/jog.2022.70

flowline = 'Exp/Kanger_flowline.exp';
...
calving_threshold = 1e7; %Default 1e7, change to whatever you would like 

number_of_years = 76; %Length of simulation from 2024

run_name = 'kangerlussuaq_ssp245_melt4_calving1e7';

%% Transient run - do not edit this section

load('./Model_Data/Kangerlussuaq_Spinup.mat');
...
switch smb_scenario
    case{'ssp245'} 
        ...
        load('Model_Data/Kanger_SMB_ssp245.mat');
    case{'ssp585'}
        %smb_file='./Model_Data/MARv3.11.3-ssp585-combined.nc';
        load('Model_Data/Kanger_SMB_ssp585.mat');
end
...
md.basalforcings.deepwater_melting_rate = 40;
...
md.calving.stress_threshold_floatingice=300e3;
...
md.timestepping.time_step = (1/48); % Adaptive test suggested 0.01 (1/96), but this is so slow to run...
