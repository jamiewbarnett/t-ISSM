...
GL_melt = 100; % Default = 55 m/yr

run_name = 'ice_go_byebye'; %Important to name your run well. 

%% %%%%%%%%%%%%%% Code to Run Simulation %%%%%%%%%%%%%%%

load(['79_Spinup_Calving_' calving_law '.mat']); %Load spun-up model 
...
for yy=1021:((2100-2025)+11)*12 % Monthly data
...
md.smb.mass_balance = [smbMAR/1000*12*(md.materials.rho_freshwater/md.materials.rho_ice); ...
    [2099:1/12:2100-(1/12)]]; % Monthly transient forcing
...
md = thinmodel(md,2025:1/12:final_year); %Produce a yearly output
